...
int vsl::ShipController::getMinThrustPower() {
	return m_dyn->m_engine_orders[0];
}

int vsl::ShipController::getMaxThrustPower() {
	return m_dyn->m_engine_orders[m_dyn->m_engine_orders.size() - 1];
}
